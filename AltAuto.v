...
Proof.
  ...
  - (* MApp *) simpl.
    destruct re1;
    [ inversion IH1 | inversion IH1; simpl; destruct re2; assumption |
 ...
 - (* MStar0 *) destruct re; simpl;
      [ idtac | idtac | idtac |
        idtac | idtac | destruct re];
    constructor.
 - (* MStarApp *) simpl.
   destruct re;
