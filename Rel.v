...
Proof.
  ...
  intros.
  specialize H with (x := 0) (y1 := 1) (y2 := 2).
  assert (A: 1 = 2).
  { apply H. apply te. apply te. }
  discriminate A.
  Qed.
(** [] *)
...
Proof.
  ...
  - apply (le_trans (S n) m (S m)).
    apply Hnm. apply le_S. apply le_reflexive.
  - apply (le_trans (S n) m' (S m')).
    apply IHHm'o. apply le_S. apply le_reflexive.
  Qed.
(** [] *)
...
Proof.
  ...
  intros.
  assert (A: 2 <= 1).
    { apply (H 1 2). apply le_S. apply le_reflexive. }
  inversion A. inversion H1.
  Qed.  
(** [] *)
...
Proof.
  ...
  induction H.
  - reflexivity.
  - apply le_Sn_le in H0 as H1. apply IHle in H1.
    rewrite H1 in H0. apply le_Sn_n in H0. 
    destruct H0.
  Qed. 
(** [] *)
...
Proof.
  ...
  - apply H0.
  - subst.
    apply (rt1n_trans R x y z). apply Hxy.
